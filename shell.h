 ...
 * @num: Refers to the number field
 * @str: a string
 ...
 *@arg: Refers a string generated from getline containing arguments
 *@argv: Refers to an array of strings generated from arg
 *@path: Refers to a string path for the current command
 *@argc: Refers to the argument count
 *@line_count: Refers to the error count
 *@err_num: Refers to the error code for exit()s
 *@linecount_flag: if on, count this line of input
 *@fname: Refers the program filename
 ...
 *@histcount: refers the history line number count
 */
...
/**
 *struct builtin - Function contains a builtin string and related function
